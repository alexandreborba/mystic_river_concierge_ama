...
@define('NEXT_PAGE', '_dailyPrograms.sbm');
@define('PREVIUS_PAGE', '_dailyPrograms.lst');
...
if ($id) {
    ...
    foreach ($dailyProgram->Data() as $field => $value) {
        ${$field} = ($field !== '') ? trim($value) : null;
    }
    $dpUUID = (empty($dpUUID)) ? $newUUID : $dpUUID;
}
            ...
            <div class="col-md-12">
              <div class="grid simple">
                ...
                <form name="form" action="<?php echo NEXT_PAGE; ?>" method="post" enctype="multipart/form-data">
                  ...
                  <input type="hidden" id="dpUUID"   name="dpUUID"   value="<?=$dpUUID; ?>">
                  <?php
                  if ($action = 'upd') {
                      echo ($dpID) ? chr(10).chr(9).chr(9).chr(9).chr(9)."<input type='hidden' id='dpID' name='dpID' value='{$dpID}'>".chr(10) : null;
                      echo "<input type='hidden' id='dpFile' name='dpFile' value='{$dpFile}'>".chr(10);
                      echo ($dpFileOriginal) ? chr(9).chr(9).chr(9).chr(9)."<input type='hidden' id='dpFileOriginal' name='dpFileOriginal' value='{$dpFileOriginal}'>".chr(10) : null;
                  }// end if
?>
                  <!-- row -->  
                  <div class="row">
                    ...
                    <div class="col-md-4 col-sm-4 col-xs-4">
                      <div class="form-group">                        
                        ...
                        <div class="controls">
                        <p style='font-family:roboto;color:#dadada;font-weight:bold'><?=$dpUUID;?></p>
                        </div>
                      </div>
                    </div>
                  ...
                  <div class="row" style="margin-top:1%">
                    ...
                    <div class="col-md-2 col-sm-2 col-xs-2">
                      <div class="form-group">
                        ...
                        <div class="controls">
                          <input type="date" id="dpDate" name="dpDate"  class="form-control" style="font-weight:bold"  value="<?=$dpDate;?>">
                          <label id="dpDate" style="padding-left:5px;font-size:12px" class="form-label error"></label>
                        </div>
                      </div>
                    </div>
                  ...
                  <div class="row">
                    ...
                    <div class="col-md-6 col-sm-6 col-xs-6">
                      <div class="form-group">
                        <label class="form-label">Daily Program Name</label>
                        <span class="help"></span>
                        <div class="controls">
                          <input type="text" id="dpName" name="dpName"  class="form-control" style="font-weight:bold"  value="<?=$dpName; ?>">
                          <label id="dpName" style="padding-left:5px;font-size:12px" class="form-label error"></label>
                        </div>
                      </div>
                    </div>
                  ...
                  <div class="row" style="margin-top:1%">
                    <div class="col-md-10 col-sm-10 col-xs-10">
                     <label class="form-label">File <?=$dpFile;?> Preview</label>
                        <div class="controls" style="text-align:center">
                          <img src="../<?=CONCIERGE_DP_IMAGE_FOLDER.DS.$dpFile.'?'.f_dateimagerenew();?>" style="width:90%; border:1px dotted #eaeaea; padding:5px; margin:5px;">
                        </div>
                  ...
                  <div class="row" style="margin-top:2%">    
                    ...
                    <div class="col-md-10 col-sm-10 col-xs-10">
                      ...
                      <span class="help">(png, jpg, jpeg and webp)</span>
                        <div class="controls">
                          <input type="file" id="dpFileNew" name="dpFileNew"  class="form-control" accept="image/png,image/jpg,image/jpeg,image/webp" c>
                          <label id="dpFileNew" style="padding-left:5px;font-size:12px" class="form-label error"></label>
                        </div>
                      </div>
                    </div>
                  ...
                  <!-- end row -->
                  <?php     
                      if($dpFile && file_exists('../'.CONCIERGE_DP_IMAGE_FOLDER.DS.$dpFile)){
                  ?>
                  <!-- row -->  
                  <div class="row" style="margin-top:1%">
                  ...
                  <div class="col-md-2 col-sm-2 col-xs-2">
                    <div class="form-group">
                      ...
                      <div class="controls">
                        <p style='color:#0969da'><?=($dpFileSize) ? f_filesSizeFormatShort($dpFileSize) : null ; ?></p>
                      </div>
                    </div>
                  </div>
                  ...
                  <div class="col-md-2 col-sm-2 col-xs-2">
                    <div class="form-group">
                      ...
                      <div class="controls">
                        <p style='color:#0969da'><?=$dpFileDimensions; ?></p>
                      </div>
                    </div>
                  </div>
                  ...
                  <div class="row" style="margin-top:1%">
                    ...
                    <div class="col-md-2 col-sm-2 col-xs-2">
                      <div class="form-group">
                        ...
                        <span class="help"></span>
                        <div class="controls">
                          <select class="form-control" name="dpStatus" id="dpStatus">
                          <?php
                          if ($aDpStatus) {
                            foreach ($aDpStatus as $key => $value) {
                              $selected = ($key == $dpStatus) ? 'selected' : '';
                    ...
                    <div class="col-md-8 col-sm-8 col-xs-8">
                      <div class="form-group">
                        <div class="controls">
                          ...
                          <?php echo (isset($dpID)) ? "<button class='btn btn-danger' name='btnDelete' style='width:100px;margin-right:20px'>Delete</button>" : null; ?>
      ...
      $(document).ready(function() {
        ...
        function formValidate(){
          ...
          if ($("input[name=dmDate]").val() == "")  {
            err.push(['dpDate', 'Enter the Date']);
          }
          
          if($("input[name=action]").val() == "ins" && $("input[name=dpFile]").val() == ""){
            if ($("input[name=dpFileNew]").val() == "")  {
              err.push(['dpFileNew', 'Select the file']);
            }
          }
