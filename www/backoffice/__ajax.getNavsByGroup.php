...
if($_POST["navGroupUUID"]){
    ...
    $navs = (new SysNavs())->find("navGroupUUID=:uuid AND navStatus=:st AND deleted_at IS NULL", "uuid={$navGroupUUID}&st=1")->order("navSeq")->fetch(true);
    ...
    if($navs){
        ...
        echo '<option value=""> - Nenhum Item para este Grupo ! - </option>';
    }
} // end if