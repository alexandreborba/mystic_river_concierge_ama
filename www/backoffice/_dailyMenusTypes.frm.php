...
@define('PAGE_NAME', 'DAILY MENU TYPES');
@define('NEXT_PAGE', '_dailyMenusTypes.sbm');
@define('PREVIUS_PAGE', '_dailyMenusTypes.lst');
...
if ($id) {
    ...
    foreach ($dmType->Data() as $field => $value) {
        ${$field} = ($field !== '') ? trim($value) : null;
    }
    $dmTypeUUID = (empty($dmTypeUUID)) ? $newUUID : $dmTypeUUID;
}
            ...
            <div class="col-md-12">
              <div class="grid simple">
                ...
                <form name="form" action="<?php echo NEXT_PAGE; ?>" method="post" enctype="multipart/form-data">
                  ...
                  <input type="hidden" id="dmTypeUUID" name="dmTypeUUID" value="<?=$dmTypeUUID; ?>">
                  <?php
                  if ($action = 'upd') {
                      echo ($dmTypeID)   ? chr(10).chr(9).chr(9).chr(9).chr(9)."<input type='hidden' id='dmTypeID' name='dmTypeID' value='{$dmTypeID}'>".chr(10) : null;
                  }// end if
?>
                  <!-- row -->  
                  <div class="row">
                    ...
                    <div class="col-md-4 col-sm-4 col-xs-4">
                      <div class="form-group">                        
                        ...
                        <div class="controls">
                        <p style='font-family:roboto;color:#dadada;font-weight:bold'><?=$dmTypeUUID; ?></p>
                        </div>
                      </div>
                    </div>
                  ...
                  <div class="row">
                    ...
                    <div class="col-md-6 col-sm-6 col-xs-6">
                      <div class="form-group">
                        ...
                        <div class="controls">
                          <input type="text" id="dmTypeName" name="dmTypeName"  class="form-control" style="font-weight:bold"  value="<?=$dmTypeName; ?>">
                          <label id="dmTypeName" style="padding-left:5px;font-size:12px" class="form-label error"></label>
                        </div>
                      </div>
                    </div>
                  ...
                  <div class="row">
                    ...
                    <div class="col-md-2 col-sm-2 col-xs-2">
                      <div class="form-group">
                        ...
                        <span class="help"></span>
                        <div class="controls">
                          <select class="form-control" name="dmTypeStatus" id="dmTypeStatus">
                          <?php
                          if ($aDmTypeStatus) {
                          foreach ($aDmTypeStatus as $key => $value) {
                          $selected = ($key == $dmTypeStatus) ? 'selected' : '';
                    ...
                    <div class="col-md-8 col-sm-8 col-xs-8">
                      <div class="form-group">
                        <div class="controls">
                          ...
                          <?php echo (isset($dmTypeID)) ? "<button class='btn btn-danger' name='btnDelete' style='width:100px;margin-right:20px'>Delete</button>" : null; ?>
    ...
    <script>
      $(document).ready(function() {
        ...
        function formValidate(){
          ...
          if ($("input[name=dmTypeName]").val() == "")  {
            err.push(['dmTypeName', 'Enter the Type Name']);
          }
