...
@define('PAGE_NAME', 'Grupos do Menu de Navegação');
@define('PREVIUS_PAGE', null);
@define('NEXT_PAGE', '_navGroups.frm');
              ...
              <div class="grid simple ">
                ...
                <div class="grid-body ">
                  <table class="table table-striped" id="datalist">
                    ...
                    $nGroups = (new SysNavGroups())->find("deleted_at IS NULL")->fetch(true);
                    if($nGroups){
                        foreach($nGroups as $nGroup){
                    ?>

                    <tr class="odd gradeX">
                        <td style="text-align:center;vertical-align: middle;"><?=$nGroup->navGroupID?></td>
                        <!-- 
                        <td style="text-align:center;vertical-align: middle;">
                          <a href="<?=NEXT_PAGE?>?ref=<?=f_encode($nGroup->navGroupID)?>" ><?=$nGroup->navGroupUUID?></a>
                        </td>
                        -->
                        <td style="text-align:left;vertical-align: middle;font-weight:bold"><?=$nGroup->navGroupName?></td>
                        <td style="text-align:left;vertical-align: middle;font-weight:bold"><?=$nGroup->navGroupSeq?></td>
                        <td style="text-align:center;vertical-align: middle;">
                          <span style="padding:10px 30px 10px 30px;" class="label <?=$aNavSubGroupsStatusLabel[$nGroup->navGroupStatus]?>"><?=$aNavSubGroupsStatus[$nGroup->navGroupStatus]?></span>
                        </td>
                        <td class="center" style="text-align:center;vertical-align: middle;">
                            <a href="<?=NEXT_PAGE?>?ref=<?=f_encode($nGroup->navGroupID)?>" class="btn btn-success" style="width:100px;">Editar</a>
                        </td>
                      </tr>
