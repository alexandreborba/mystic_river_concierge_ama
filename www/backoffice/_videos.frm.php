...
@define('NEXT_PAGE', '_videos.sbm');
@define('PREVIUS_PAGE', '_videos.lst');
...
if ($id) {
    $action = 'upd';
    $video = (new Videos())->findById($id);
    foreach ($video->Data() as $field => $value) {
        ${$field} = ($field !== '') ? trim($value) : null;
    }
    $videoUUID = (empty($videoUUID)) ? $newUUID : $videoUUID;
}
            ...
            <div class="col-md-12">
              <div class="grid simple">
                <div class="grid-title no-border" style="padding:10px 0px 10px 20px">
                  <h3><videon class="semi-bold" style="color:#02244F"><?php echo PAGE_NAME.' '.f_upper($actionsTitles[$action]); ?></videon></h3>
                  <hr>
                </div>
                ...
                <form name="form" action="<?php echo NEXT_PAGE; ?>" method="post" enctype="multipart/form-data">
                  ...
                  <input type="hidden" id="videoUUID" name="videoUUID" value="<?=$videoUUID; ?>">
                  <?php
                  if ($action = 'upd') {
                      echo ($videoID) ? chr(10).chr(9).chr(9).chr(9).chr(9)."<input type='hidden' id='videoID' name='videoID' value='{$videoID}'>".chr(10) : null;
                      echo "<input type='hidden' id='videoFile' name='videoFile' value='{$videoFile}'>".chr(10);
                      echo ($videoFileOriginal) ? chr(9).chr(9).chr(9).chr(9)."<input type='hidden' id='videoFileOriginal' name='videoFileOriginal' value='{$videoFileOriginal}'>".chr(10) : null;
                  }// end if
?>
                  <!-- row -->  
                  <div class="row">
                    ...
                    <div class="col-md-4 col-sm-4 col-xs-4">
                      <div class="form-group">                        
                        ...
                        <div class="controls">
                        <p style='font-family:roboto;color:#dadada;font-weight:bold'><?=$videoUUID; ?></p>
                        </div>
                      </div>
                    </div>
                  ...
                  <div class="row" style="margin-top:1%">
                    ...
                    <?php 
                      ...
                      if($videoFile && file_exists('../'.CONCIERGE_VIDEOS_FOLDER.$videoFile)){
                        
                        echo    '<div class="col-md-8 col-sm-8 col-xs-8">';
                        echo      '<label class="form-label">File</label>';
                        echo      '<div class="controls">';
                        echo        '<video controls muted autoplay loop style="width:100%">';
                        echo            '<source src="../'.CONCIERGE_VIDEOS_FOLDER.$videoFile.'" type="video/mp4">';
                        echo        '</video>';
                        echo      '</div>';
                        echo    '</div>';
                    ...
                    <div class="col-md-5 col-sm-5 col-xs-5">
                      <div class="form-group">
                        <label class="form-label">New Video File [ 4K 2160p 3840 x 2160px is the recommended size ]</label><br>
                        <videon class="help">(mp4)</videon>
                        <div class="controls">
                          <input type="file" id="videoFileNew" name="videoFileNew"  class="form-control" accept="video/mp4" >
                          <label id="videoFileNew" style="padding-left:5px;font-size:12px" class="form-label error"></label>
                        </div>
                      </div>
                    </div>
                  ...
                  <?php     
                      if($videoFile && file_exists('../'.CONCIERGE_VIDEOS_FOLDER.$dmFile)){
                  ?>
                  <!-- row -->  
                  ...
                  <div class="col-md-3 col-sm-3 col-xs-3">
                    <div class="form-group">
                      ...
                      <div class="controls">
                        <p style='color:#0969da'><?=f_filesSizeFormatShort($videoFileSize); ?></p>
                      </div>
                    </div>
                  </div>
                  ...
                  <div class="col-md-3 col-sm-3 col-xs-3">
                    <div class="form-group">
                      ...
                      <div class="controls">
                        <p style='color:#0969da'><?=$videoFileDimensions; ?></p>
                      </div>
                    </div>
                  </div>
                  ...
                  <div class="row" style="margin-top:2%">
                    ...
                    <div class="col-md-6 col-sm-6 col-xs-6">
                      <div class="form-group">
                        ...
                        <videon class="help"></videon>
                        <div class="controls">
                          <input type="text" id="videoFileTitle" name="videoFileTitle"  class="form-control" style="font-weight:bold"  value="<?=$videoFileTitle;?>">
                          <label id="videoFileTitle" style="padding-left:5px;font-size:12px" class="form-label error"></label>
                        </div>
                      </div>
                    </div>
                    ...
                    <div class="col-md-2 col-sm-2 col-xs-2">
                      <div class="form-group">
                        ...
                        <videon class="help"></videon>
                        <div class="controls">
                          <input type="number" id="videoOrder" name="videoOrder"  class="form-control" style="font-weight:bold;text-align:right;"  value="<?=$videoOrder;?>">
                          <label id="videoOrder" style="padding-left:5px;font-size:12px" class="form-label error"></label>
                        </div>
                      </div>
                    </div>
                        ...
                        <div class="controls">
                          ...
                          if ($aSpasStatus) {
                            foreach ($aSpasStatus as $key => $value) {
                              $selected = ($key == $videoStatus) ? 'selected' : '';
                    ...
                    <div class="col-md-8 col-sm-8 col-xs-8">
                      <div class="form-group">
                        <div class="controls">
                          ...
                          <?php echo (isset($videoID)) ? "<button class='btn btn-danger' name='btnDelete' style='width:100px;margin-right:20px'>Delete</button>" : null; ?>
    ...
    <script>
      $(document).ready(function() {
        ...
        function formValidate(){
          ...
          if ($("input[name=videoFileTitle]").val() == "")  {
              err.push(['videoFileTitle', 'inform a file title']);
            }
        
          if($("input[name=action]").val() == "ins" && $("input[name=videoFile]").val() == ""){
            if ($("input[name=videoFileNew]").val() == "")  {
              err.push(['videoFileNew', 'Select the file']);
            }
          }
