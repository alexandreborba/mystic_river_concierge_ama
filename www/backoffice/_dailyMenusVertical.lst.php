...
@define('PAGE_NAME', $dict->translate('RESTAURANT MENUS', $langCode));
@define('PREVIUS_PAGE', null);
@define('NEXT_PAGE', '_dailyMenusVertical.frm');

@define('MODEL', 'DailyMenusVerticais');
@define('statusField', 'dmvStatus');
@define('fieldQuery', 'dmvUUID');
                  ...
                  <table class="table table-striped" id="datalist">
                      <thead>
                          <tr>
                              ...
                              <th style="text-align:left;width:5%"><?=$dict->translate('Ord',$langCode);?></th>
                        ...
                        if ($records) {
                          foreach ($records as $record) {
                                ?> <tr>
                        <td style="text-align:center;vertical-align:middle"><?= $record->dmvID ?></td>
                        <!-- <td style="text-align:center;vertical-align:middle"><?= $record->dmvUUID ?></td> -->
                        <td style="vertical-align:middle;font-weight:bold"><?= $record->dmvName ?></td>
                        <td style="vertical-align:middle;font-weight:normal"><?= $lstMenuTypes[$record->dmTypeUUID] ?></td>
                        <td style="vertical-align:middle;font-weight:bold"><?= $record->dmvOrder ?></td>
                        <td style="text-align:center;vertical-align:middle"><?= f_filesSizeFormatShort($record->dmvFileSize) ?></td>
                        <td style="text-align:center;vertical-align: middle;font-weight:normal"><?=$record->dmvFileDimensions.' px'?></td>
                        <td style="text-align:center;vertical-align:middle">
                          <a href="#" name="changeThisStatus" title='<?=$dict->translate('Click here to Change Status!',$langCode)?>'data="<?=$record->dmvUUID?>,<?=statusField?>" style='border-radius:10px;padding:8%' class="label <?= $aDmvStatusLabel[$record->dmvStatus] ?>" >
                            <?= $aDmvStatus[$record->dmvStatus] ?>
                          </a>
                        </td>
                        <td style="text-align:center;vertical-align:middle">
                          <a href="<?= NEXT_PAGE ?>?ref=<?= f_encode($record->dmvID) ?>"
