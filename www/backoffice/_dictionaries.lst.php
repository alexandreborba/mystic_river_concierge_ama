...
@define('PAGE_NAME', $dict->translate('Dictionaries', $langCode));
@define('PREVIUS_PAGE', null);
@define('NEXT_PAGE', '_dictionaries.frm');

@define('MODEL', 'SysDictionaries');
@define('statusField', 'dictStatus');
@define('fieldQuery', 'dictUUID');
                  ...
                  <table class="table table-striped" id="datalist">
                      <thead>
                          <tr>
                              ...
                              <th style="text-align:left;width:25%"><?=$dict->translate('English content',$langCode);?></th>
                              <th style="text-align:center;width:7%"><?=$dict->translate('Language',$langCode);?></th>
                              <th style="text-align:left;width:25%"><?=$dict->translate('Content Translated into Language',$langCode);?></th>
                              <th style="text-align:center;width:10%"><?=$dict->translate('Status',$langCode);?></th>
                        ...
                        ?> 
                        <tr>
                          <td style="text-align:center;vertical-align:middle"><?= $record->dictID ?></td>
                          <!-- <td style="text-align:center;vertical-align:middle"><?= $record->dictUUID ?></td> -->
                          <td style="text-align:left;vertical-align:middle;font-weight:bold"><?= $record->dictContentEN ?></td>
                          <td style="text-align:center;vertical-align:middle;font-weight:bold"><?= $record->langCode ?></td>
                          <td style="text-align:left;vertical-align:middle;font-weight:bold"><?= $record->dictContentTranslated ?></td>

                          <td style="text-align:center;vertical-align:middle">
                            <a href="#" name="changeThisStatus" title='<?=$dict->translate('Click here to Change Status!',$langCode)?>' data="<?=$record->dictUUID?>,<?=statusField?>" style='border-radius:10px;padding:8%' class="label <?= $aDictionariesStatusLabel[$record->dictStatus] ?>" >
                              <?= $dict->translate($aDictionariesStatus[$record->dictStatus],$langCode); ?>
                            </a>
                          </td>
                          <td style="text-align:center;vertical-align:middle">
                            <a href="<?= NEXT_PAGE ?>?ref=<?= f_encode($record->dictID) ?>"
                              class="btn btn-success" style="width:100px;"><?=$dict->translate('Change',$langCode);?></a>
                          </td>
                        </tr>
                      <?php
                          }
