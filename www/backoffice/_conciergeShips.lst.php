...
@define('PAGE_NAME', $dict->translate('CONCIERGE CFG', $langCode));
@define('PREVIUS_PAGE', null);
@define('NEXT_PAGE', '_conciergeShips.frm');

@define('MODEL', 'ConciergeShips');
@define('statusField', 'shipStatus');
@define('fieldQuery', 'shipUUID');
$sCode = shipCode;
?>
                  ...
                  <table class="table table-striped" id="datalist">
                      <thead>
                          <tr>
                              ...
                              <!-- <th style="text-align:left;width:15%">MENU POS.</th> -->
                        ...
                        <?php 
                            ...
                            $cShips = (new ConciergeShips())->find("shipCode=:sCode","sCode={$sCode}")->fetch(true);
                            if($cShips){
                                foreach($cShips as $cShip){
                                ?>
                                    <tr class="odd gradeX">
                                        <td style="text-align:center;vertical-align: middle;"><?=$cShip->shipID?></td>
                                        <!-- 
                                        <td style="text-align:center;vertical-align: middle;">
                                        <a href="<?=NEXT_PAGE?>?ref=<?=f_encode($cShip->shipID)?>" ><?=$cShip->shipUUID?></a>
                                        </td>
                                        -->
                                        <td style="text-align:center;vertical-align: middle;font-weight:normal"><?=$cShip->shipCode?></td>
                                        <td style="text-align:left;vertical-align: middle;font-weight:normal"><?=$cShip->shipName?></td>
                                        <!-- <td style="text-align:left;vertical-align: middle;font-weight:normal"><?=$aMenuPositions[$cShip->shipMenuPosition]?></td> -->
                                        
                                        <td style="text-align:center;vertical-align: middle;">
                                        <span style="padding:10px 30px 10px 30px;" class="label <?=$aCShipStatusLabel[$cShip->shipStatus]?>"><?=$aCShipStatus[$cShip->shipStatus]?></span>
                                        </td>
                                        <td class="center" style="text-align:center;vertical-align: middle;">
                                            <a href="<?=NEXT_PAGE?>?ref=<?=f_encode($cShip->shipID)?>" class="btn btn-success" style="width:100px;">Change</a>
                                        </td>
                                    </tr>
