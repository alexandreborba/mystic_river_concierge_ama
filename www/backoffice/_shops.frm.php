...
@define('PAGE_NAME', 'SHOPS');
@define('NEXT_PAGE', '_shops.sbm');
@define('PREVIUS_PAGE', '_shops.lst');
...
if ($id) {
    ...
    foreach ($shop->Data() as $field => $value) {
        ${$field} = ($field !== '') ? trim($value) : null;
    }
    $shopUUID = (empty($shopUUID)) ? $newUUID : $shopUUID;
}
            ...
            <div class="col-md-12">
              <div class="grid simple">
                ...
                <form name="form" action="<?php echo NEXT_PAGE; ?>" method="post" enctype="multipart/form-data">
                  ...
                  <input type="hidden" id="shopUUID"   name="shopUUID"   value="<?=$shopUUID; ?>">
                  <?php
                  if ($action = 'upd') {
                      echo ($shopID) ? chr(10).chr(9).chr(9).chr(9).chr(9)."<input type='hidden' id='shopID' name='shopID' value='{$shopID}'>".chr(10) : null;
                      echo "<input type='hidden' id='shopFile' name='shopFile' value='{$shopFile}'>".chr(10);
                      echo ($shopFileOriginal) ? chr(9).chr(9).chr(9).chr(9)."<input type='hidden' id='shopFileOriginal' name='shopFileOriginal' value='{$shopFileOriginal}'>".chr(10) : null;
                  }// end if
?>
                  <!-- row -->  
                  <div class="row">
                    ...
                    <div class="col-md-4 col-sm-4 col-xs-4">
                      <div class="form-group">                        
                        ...
                        <div class="controls">
                        <p style='font-family:roboto;color:#dadada;font-weight:bold'><?=$shopUUID;?></p>
                        </div>
                      </div>
                    </div>
                  ...
                  <div class="row" style="margin-top:1%">
                    ...
                    <div class="col-md-2 col-sm-2 col-xs-2">
                      <div class="form-group">
                        ...
                        <div class="controls">
                          <input type="date" id="shopDate" name="shopDate"  class="form-control" style="font-weight:bold"  value="<?=$shopDate;?>">
                          <label id="shopDate" style="padding-left:5px;font-size:12px" class="form-label error"></label>
                        </div>
                      </div>
                    </div>
                  ...
                  <div class="row" style="margin-top:1%">
                    ...
                    <div class="col-md-6 col-sm-6 col-xs-6">
                      <div class="form-group">
                        ...
                        <span class="help"></span>
                        <div class="controls">
                          <input type="text" id="shopName" name="shopName"  class="form-control" style="font-weight:bold"  value="<?=$shopName; ?>">
                          <label id="shopName" style="padding-left:5px;font-size:12px" class="form-label error"></label>
                        </div>
                      </div>
                    </div>
                  ...
                  <div class="row" style="margin-top:1%">
                    <div class="col-md-10 col-sm-10 col-xs-10">
                     <label class="form-label">File <?=$shopFile;?> Preview</label>
                        <div class="controls" style="text-align:center">
                          <img src="../<?=CONCIERGE_SHOPS_IMAGE_FOLDER.DS.$shopFile.'?'.f_dateimagerenew();?>" style="width:90%; border:1px dotted #eaeaea; padding:5px; margin:5px;">
                        </div>
                  ...
                  <div class="row" style="margin-top:2%">    
                    ...
                    <div class="col-md-10 col-sm-10 col-xs-10">
                      ...
                      <span class="help">(png, jpg, jpeg and webp)</span>
                        <div class="controls">
                          <input type="file" id="shopFileNew" name="shopFileNew"  class="form-control" accept="image/png,image/jpg,image/jpeg,image/webp" c>
                          <label id="shopFileNew" style="padding-left:5px;font-size:12px" class="form-label error"></label>
                        </div>
                      </div>
                    </div>
                  ...
                  <!-- end row -->
                  <?php     
                      if($shopFile && file_exists('../'.CONCIERGE_SHOPS_IMAGE_FOLDER.DS.$shopFile)){
                  ?>
                  <!-- row -->  
                  <div class="row" style="margin-top:1%">
                  ...
                  <div class="col-md-2 col-sm-2 col-xs-2">
                    <div class="form-group">
                      ...
                      <div class="controls">
                        <p style='color:#0969da'><?=($shopFileSize) ? f_filesSizeFormatShort($shopFileSize) : null ; ?></p>
                      </div>
                    </div>
                  </div>
                  ...
                  <div class="col-md-2 col-sm-2 col-xs-2">
                    <div class="form-group">
                      ...
                      <div class="controls">
                        <p style='color:#0969da'><?=$shopFileDimensions; ?></p>
                      </div>
                    </div>
                  </div>
                  ...
                  <div class="row" style="margin-top:1%">
                    ...
                    <div class="col-md-2 col-sm-2 col-xs-2">
                      <div class="form-group">
                        ...
                        <span class="help"></span>
                        <div class="controls">
                          <select class="form-control" name="shopStatus" id="shopStatus">
                          <?php
                          if ($aSpasStatus) {
                            foreach ($aSpasStatus as $key => $value) {
                              $selected = ($key == $shopStatus) ? 'selected' : '';
                    ...
                    <div class="col-md-8 col-sm-8 col-xs-8">
                      <div class="form-group">
                        <div class="controls">
                          ...
                          <?php echo (isset($shopID)) ? "<button class='btn btn-danger' name='btnDelete' style='width:100px;margin-right:20px'>Delete</button>" : null; ?>
      ...
      $(document).ready(function() {
        ...
        function formValidate(){
          ...
          if ($("input[name=dmDate]").val() == "")  {
            err.push(['shopDate', 'Enter the Date']);
          }
          
          if($("input[name=action]").val() == "ins" && $("input[name=shopFile]").val() == ""){
            if ($("input[name=shopFileNew]").val() == "")  {
              err.push(['shopFileNew', 'Select the file']);
            }
          }
