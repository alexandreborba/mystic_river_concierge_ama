...
@define('NEXT_PAGE', '_slidesShows.frm');
                  ...
                  <table class="table table-striped" id="datalist">
                      <thead>
                          <tr>
                              ...
                              <th style="text-align:left;width:20%">CAPTION</th>
                        ...
                        <?php 
                            ...
                            $slides = (new SlidesShows())->find("shipCode=:ship AND deleted_at IS NULL","ship={$sCode}")->fetch(true);
                            if($slides){
                        foreach($slides as $slide){
                    ?>
                    <tr class="odd gradeX">
                        <td style="text-align:center;vertical-align: middle;"><?=$slide->slideID?></td>
                        <!-- 
                        <td style="text-align:center;vertical-align: middle;">
                          <a href="<?=NEXT_PAGE?>?ref=<?=f_encode($slide->slideID)?>" ><?=$slide->slideUUID?></a>
                        </td>
                        -->
                        <td style="text-align:left;vertical-align: middle;font-weight:normal"><?=$slide->slideCaption?></td>
                        <td style="text-align:left;vertical-align: middle;font-weight:bold"><?=$slide->slideFileOriginal?></td>
                        <td style="text-align:center;vertical-align: middle;font-weight:bold"><?=f_filesSizeFormatShort($slide->slideFileSize)?></td>
                        <td style="text-align:center;vertical-align: middle;font-weight:normal"><?=$slide->slideFileDimensions.' px'?></td>
                        <td style="text-align:center;vertical-align: middle;font-weight:bold"><?=$slide->slideOrder?></td>
                        <td style="text-align:center;vertical-align: middle;">
                          <span style="padding:10px 30px 10px 30px;" class="label <?=$aSlidesStatusLabel[$slide->slideStatus]?>"><?=$aSlidesStatus[$slide->slideStatus]?></span>
                        </td>
                        <td class="center" style="text-align:center;vertical-align: middle;">
                            <a href="<?=NEXT_PAGE?>?ref=<?=f_encode($slide->slideID)?>" class="btn btn-success" style="width:100px;">Change</a>
                        </td>
                      </tr>
