...
use Src\Models\DailyMenusVerticais;
use Src\Models\DailyMenusTypes;

$dmTypes = (new DailyMenusTypes())->find("dmTypeStatus=:st AND deleted_at IS NULL","st=1")->fetch(true);
if($dmTypes) {
  $lstDMTypes[0] = 'Select a type';
    foreach ($dmTypes as $dmType) {
        $lstDMTypes[$dmType->dmTypeUUID] = $dmType->dmTypeName;
    }
} // end if

@define('PAGE_NAME', 'VERTICAL DAILY MENU RESTAURANT');
@define('NEXT_PAGE', '_dailyMenusVertical.sbm');
@define('PREVIUS_PAGE', '_dailyMenusVertical.lst');
...
if ($id) {
    ...
    foreach ($dailyMenuVertical->Data() as $field => $value) {
        ${$field} = ($field !== '') ? trim($value) : null;
    }
    $dmvUUID = (empty($dmvUUID)) ? $newUUID : $dmvUUID;
}
            ...
            <div class="col-md-12">
              <div class="grid simple">
                ...
                <form name="form" action="<?php echo NEXT_PAGE; ?>" method="post" enctype="multipart/form-data">
                  ...
                  <input type="hidden" id="dmvUUID"   name="dmvUUID"   value="<?=$dmvUUID; ?>">
                  <?php
                  if ($action = 'upd') {
                      echo ($dmvID) ? chr(10).chr(9).chr(9).chr(9).chr(9)."<input type='hidden' id='dmvID' name='dmvID' value='{$dmvID}'>".chr(10) : null;
                      echo "<input type='hidden' id='dmvFile' name='dmvFile' value='{$dmvFile}'>".chr(10);
                      echo ($dmvFileOriginal) ? chr(9).chr(9).chr(9).chr(9)."<input type='hidden' id='dmvFileOriginal' name='dmvFileOriginal' value='{$dmvFileOriginal}'>".chr(10) : null;
                  }// end if
?>
                  <!-- row -->  
                  <div class="row">
                    ...
                    <div class="col-md-4 col-sm-4 col-xs-4">
                      <div class="form-group">                        
                        ...
                        <div class="controls">
                        <p style='font-family:roboto;color:#dadada;font-weight:bold'><?=$dmvUUID;?></p>
                        </div>
                      </div>
                    </div>
                  ...
                  <div class="row" style="margin-top:1%">
                    ...
                    <div class="col-md-2 col-sm-2 col-xs-2">
                      <div class="form-group">
                        ...
                        <div class="controls">
                          <input type="date" id="dmvDate" name="dmvDate"  class="form-control" style="font-weight:bold"  value="<?=$dmvDate;?>">
                          <label id="dmvDate" style="padding-left:5px;font-size:12px" class="form-label error"></label>
                        </div>
                      </div>
                    </div>
                    ...
                    <div class="col-md-2 col-sm-2 col-xs-2">
                      <div class="form-group">
                        <label class="form-label">Daily Menu Type</label>
                        <span class="help"></span>
                        <div class="controls">
                          <select class="form-control" name="dmTypeUUID" id="dmTypeUUID">
                          <?php
                          if ($lstDMTypes) {
                            foreach ($lstDMTypes as $key => $value) {
                              $selected = ($key == $dmTypeUUID) ? 'selected' : '';
                              echo "<option value='$key' $selected >$value</option>";
                            }
                          } // end iff
                          ?>
                          </select>
                          <label id="dmTypeUUID" style="padding-left:5px;font-size:12px" class="form-label error"></label>
                        </div>
                      </div>
                    </div>
                    ...
                    <div class="col-md-4 col-sm-4 col-xs-4">
                      <div class="form-group">
                        ...
                        <span class="help"></span>
                        <div class="controls">
                          <input type="text" id="dmvName" name="dmvName"  class="form-control" style="font-weight:bold"  value="<?=$dmvName; ?>">
                          <label id="dmvName" style="padding-left:5px;font-size:12px" class="form-label error"></label>
                        </div>
                      </div>
                    </div>
                    ...
                    <div class="col-md-2 col-sm-2 col-xs-2">
                      <div class="form-group">
                        <label class="form-label">Sequencia de Exibição</label>
                        <span class="help"></span>
                        <div class="controls">
                          <input type="number" id="dmvOrder" name="dmvOrder"  class="form-control" style="font-weight:bold"  value="<?=$dmvOrder; ?>">
                          <label id="dmvOrder" style="padding-left:5px;font-size:12px" class="form-label error"></label>
                        </div>
                      </div>
                    </div>
                  ...
                  <div class="row" style="margin-top:2%">    
                    ...
                    <div class="col-md-10 col-sm-10 col-xs-10">
                      <div class="form-group">
                      <label class="form-label">New Vertical Image File [ HD 1080p 1080x1920px is the recommended size ]</label><br>
                      <span class="help">(png, jpg, jpeg and webp)</span>
                        <div class="controls">
                          <input type="file" id="dmvFileNew" name="dmvFileNew"  class="form-control" accept="image/png,image/jpg,image/jpeg,image/webp" c>
                          <label id="dmvFileNew" style="padding-left:5px;font-size:12px" class="form-label error"></label>
                        </div>
                      </div>
                    </div>
                  ...
                  <div class="row" style="margin-top:1%">
                    <div class="col-md-10 col-sm-10 col-xs-10">
                     <label class="form-label">File Menu Preview</label>
                        <div class="controls" style="text-align:left" id='preview'>
                          <?php echo ( $dmvFile && file_exists('../'.CONCIERGE_DMV_IMAGE_FOLDER.DS.$dmvFile) ) ? "<img src='../".CONCIERGE_DMV_IMAGE_FOLDER.DS.$dmvFile.'?'.f_dateimagerenew()."' style='width:35%; border:1px dotted #eaeaea; padding:5px; margin:5px;'>" : null; ?>
                        </div>
                  ...
                  <div class="col-md-2 col-sm-2 col-xs-2">
                    <div class="form-group">
                      ...
                      <div class="controls">
                        <p id='fileSize' style='color:#0969da'><?=($dmvFileSize) ? f_filesSizeFormatShort($dmvFileSize) : null ; ?></p>
                      </div>
                    </div>
                  </div>
                  ...
                  <div class="col-md-2 col-sm-2 col-xs-2">
                    <div class="form-group">
                      ...
                      <div class="controls">
                        <p id='fileDimensions' style='color:#0969da'><?=($dmvFileDimensions) ? $dmvFileDimensions : null; ?></p>
                      </div>
                    </div>
                  </div>
                  ...
                  <div class="row" style="margin-top:1%">
                    ...
                    <div class="col-md-2 col-sm-2 col-xs-2">
                      <div class="form-group">
                        ...
                        <span class="help"></span>
                        <div class="controls">
                          <select class="form-control" name="dmvStatus" id="dmvStatus">
                          <?php
                          if ($aDpStatus) {
                            foreach ($aDpStatus as $key => $value) {
                              $selected = ($key == $dmvStatus) ? 'selected' : '';
                              echo "<option value='$key' $selected >$value</option>";
                            }
                          } // end iff
                          ?>
                    ...
                    <div class="col-md-8 col-sm-8 col-xs-8">
                      <div class="form-group">
                        <div class="controls">
                          ...
                          <?php echo (isset($dmvID)) ? "<button class='btn btn-danger' name='btnDelete' style='width:100px;margin-right:20px'>Delete</button>" : null; ?>
    ...
    <script>
      $(document).ready(function() {
        ...
        // Helper para formatar bytes em KB/MB
        ...
        $("input[name='dmvFileNew']").change(function(e){
          e.preventDefault();
          ...
          if (file) {
            ...
            reader.onload = function(event) {
              ...
              // limpa preview e adiciona a imagem + faz fade
              $("#preview").html($img).promise().done(function(){
                $img.fadeIn(fadeDuration);
              });

              // preenche tamanho do arquivo
              $("#fileSize").text(humanFileSize(file.size));

              // quando a imagem real terminar de carregar, pega dimensões
              $img.on('load', function(){
                const w = this.naturalWidth;
                const h = this.naturalHeight;
                $("#fileDimensions").text(`${w} × ${h} px`);
              });
            };
        ...
        function formValidate(){
          ...
          if ($("input[name=dmvDate]").val() == "")  {
            err.push(['dmvDate', 'Enter the Date']);
          }
          if ($("select[name=dmTypeUUID]").val() == "0")  {
            err.push(['dmTypeUUID', 'Select the Daily Menu Type']);
          }
          
          if($("input[name=action]").val() == "ins" && $("input[name=dmvFile]").val() == ""){
            if ($("input[name=dmvFileNew]").val() == "")  {
              err.push(['dmvFileNew', 'Select the file']);
            }
          }
