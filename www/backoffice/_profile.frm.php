            ...
            <div class="col-md-12">
              <div class="grid simple">
                <div class="grid-title no-border" style="padding:10px 0px 10px 20px">
                  <h3><span class="semi-bold" style="color:#02244F"><?=PAGE_TITLE?></span></h3>
                  <hr>
                </div>
                ...
                <div class="grid-body no-border">
                  ...
                  if($action="upd"){ 
                    ...
                    echo ($managerAdm) ?         chr(9).chr(9).chr(9).chr(9)."<input type='hidden' id='managerAdm' name='managerAdm' value='{$managerAdm}'>".chr(10) :null;
                    echo ($managerStatus) ?         chr(9).chr(9).chr(9).chr(9)."<input type='hidden' id='managerStatus' name='managerStatus' value='{$managerStatus}'>".chr(10) :null;
                  } // end if
                  ?>
                  <!-- row -->  
                  <div class="row">
                    ...
                    <div class="col-md-11 col-sm-11 col-xs-11">
                      <div class="form-group">                        
                        ...
                        <div class="controls">
                        <p style='font-family:roboto;color:#dadada;font-weight:bold'><?=$managerUUID?></p>
                        </div>
                      </div>
                    </div>
                ...
                <div class="row">
                  ...
                  <div class="col-md-8 col-sm-8 col-xs-8">
                    <div class="form-group">
                      <div class="controls">
                        <button class="btn btn-success" name="btnSubmit" style="width:100px;margin-right:20px">Save</button>
                      </div>
                    </div>
                  </div>
