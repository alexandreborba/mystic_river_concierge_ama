...
@define('NEXT_PAGE', '_dailyMenus.sbm');
...
if ($id) {
    ...
    foreach ($dailyMenu->Data() as $field => $value) {
        ${$field} = ($field !== '') ? trim($value) : null;
    }
    $dmUUID = (empty($dmUUID)) ? $newUUID : $dmUUID;
}
            ...
            <div class="col-md-12">
              <div class="grid simple">
                ...
                <form name="form" action="<?php echo NEXT_PAGE; ?>" method="post" enctype="multipart/form-data">
                  ...
                  <input type="hidden" id="dmUUID"   name="dmUUID"   value="<?=$dmUUID; ?>">
                  <?php
                  if ($action = 'upd') {
                      echo ($dmID) ? chr(10).chr(9).chr(9).chr(9).chr(9)."<input type='hidden' id='dmID' name='dmID' value='{$dmID}'>".chr(10) : null;
                      echo "<input type='hidden' id='dmFile' name='dmFile' value='{$dmFile}'>".chr(10);
                      echo ($dmFileOriginal) ? chr(9).chr(9).chr(9).chr(9)."<input type='hidden' id='dmFileOriginal' name='dmFileOriginal' value='{$dmFileOriginal}'>".chr(10) : null;
                  }// end if
                  ?>
                  <!-- row -->  
                  <div class="row">
                    ...
                    <div class="col-md-4 col-sm-4 col-xs-4">
                      <div class="form-group">                        
                        ...
                        <div class="controls">
                        <p style='font-family:roboto;color:#dadada;font-weight:bold'><?=$dmUUID;?></p>
                        </div>
                      </div>
                    </div>
                  ...
                  <div class="row" style="margin-top:1%">
                    ...
                    <div class="col-md-2 col-sm-2 col-xs-2">
                      <div class="form-group">
                        ...
                        <div class="controls">
                          <input type="date" id="dmDate" name="dmDate"  class="form-control" style="font-weight:bold"  value="<?=$dmDate;?>">
                          <label id="dmDate" style="padding-left:5px;font-size:12px" class="form-label error"></label>
                        </div>
                      </div>
                    </div>
                  ...
                  <div class="row" style="margin-top:1%">
                    ...
                    <div class="col-md-6 col-sm-6 col-xs-6">
                      <div class="form-group">
                        ...
                        <span class="help"></span>
                        <div class="controls">
                          <input type="text" id="dmName" name="dmName"  class="form-control" style="font-weight:bold"  value="<?=$dmName; ?>">
                          <label id="dmName" style="padding-left:5px;font-size:12px" class="form-label error"></label>
                        </div>
                      </div>
                    </div>
                  ...
                  <div class="row" style="margin-top:1%">
                    <div class="col-md-10 col-sm-10 col-xs-10">
                     <label class="form-label">File <?=$dmFile;?> Preview</label>
                        <div class="controls" style="text-align:center">
                          <img src="../<?=CONCIERGE_DM_IMAGE_FOLDER.DS.$dmFile.'?'.f_dateimagerenew();?>" style="width:90%; border:1px dotted #eaeaea; padding:5px; margin:5px;">
                        </div>
                  ...
                  <div class="row" style="margin-top:2%">    
                    ...
                    <div class="col-md-10 col-sm-10 col-xs-10">
                      ...
                      <span class="help">(png, jpg, jpeg and webp)</span>
                        <div class="controls">
                          <input type="file" id="dmFileNew" name="dmFileNew"  class="form-control" accept="image/png,image/jpg,image/jpeg,image/webp" c>
                          <label id="dmFileNew" style="padding-left:5px;font-size:12px" class="form-label error"></label>
                        </div>
                      </div>
                    </div>
                  ...
                  <!-- end row -->
                  <?php     
                      if($dmFile && file_exists('../'.CONCIERGE_DM_IMAGE_FOLDER.DS.$dmFile)){
                  ?>
                  <!-- row -->  
                  <div class="row" style="margin-top:1%">
                  ...
                  <div class="col-md-2 col-sm-2 col-xs-2">
                    <div class="form-group">
                      ...
                      <div class="controls">
                        <p style='color:#0969da'><?=($dmFileSize) ? f_filesSizeFormatShort($dmFileSize) : null ; ?></p>
                      </div>
                    </div>
                  </div>
                  ...
                  <div class="col-md-2 col-sm-2 col-xs-2">
                    <div class="form-group">
                      ...
                      <div class="controls">
                        <p style='color:#0969da'><?=$dmFileDimensions; ?></p>
                      </div>
                    </div>
                  </div>
                  ...
                  <div class="row" style="margin-top:1%">
                    ...
                    <div class="col-md-2 col-sm-2 col-xs-2">
                      <div class="form-group">
                        ...
                        <span class="help"></span>
                        <div class="controls">
                          <select class="form-control" name="dmStatus" id="dmStatus">
                          <?php
                          if ($aDpStatus) {
                            foreach ($aDpStatus as $key => $value) {
                              $selected = ($key == $dmStatus) ? 'selected' : '';
                              echo "<option value='$key' $selected >$value</option>";
                            }
                          } // end iff
                          ?>
      ...
      $(document).ready(function() {
        ...
        function formValidate(){
          ...
          if ($("input[name=dmDate]").val() == "")  {
            err.push(['dmDate', 'Enter the Date']);
          }
          if ($("select[name=dmTypeUUID]").val() == "0")  {
            err.push(['dmTypeUUID', 'Select the Daily Menu Type']);
          }
          
          if($("input[name=action]").val() == "ins" && $("input[name=dmFile]").val() == ""){
            if ($("input[name=dmFileNew]").val() == "")  {
              err.push(['dmFileNew', 'Select the file']);
            }
          }
