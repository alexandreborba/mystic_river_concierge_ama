...
@define('NEXT_PAGE',    '_navSubGroups.frm');
@define('PREVIUS_PAGE', null);

include_once "__lstNavGroups.inc.php";
?>
                  ...
                  <table class="table table-striped" id="datalist">
                    <thead>
                      <tr>
                        ...
                        <th style="text-align:left;width:15%">Grupo</th>
                    ...
                    $nSubGroups = (new SysNavSubGroups())->find("deleted_at IS NULL")->fetch(true);
                    if($nSubGroups){
                        foreach($nSubGroups as $nSubGroup){
                    ?>

                    <tr class="odd gradeX">
                        <td style="text-align:center;vertical-align: middle;"><?=$nSubGroup->navSubGroupID?></td>
                        <!-- 
                        <td style="text-align:center;vertical-align: middle;">
                          <a href="<?=NEXT_PAGE?>?ref=<?=f_encode($nSubGroup->navSubGroupID)?>" ><?=$nSubGroup->navSubGroupUUID?></a>
                        </td>
                        -->
                        <td style="text-align:left;vertical-align: middle;font-weight:bold"><?=$lstNavGroups[$nSubGroup->navGroupUUID]?></td>
                        <td style="text-align:left;vertical-align: middle;font-weight:bold"><?=$nSubGroup->navSubGroupName?></td>
                        <td style="text-align:left;vertical-align: middle;font-weight:bold"><?=$nSubGroup->navSubGroupSeq?></td>
                        <td style="text-align:center;vertical-align: middle;">
                          <span style="padding:10px 30px 10px 30px;" class="label <?=$aNavSubGroupsStatusLabel[$nSubGroup->navSubGroupStatus]?>"><?=$aNavSubGroupsStatus[$nSubGroup->navSubGroupStatus]?></span>
                        </td>
                        <td class="center" style="text-align:center;vertical-align: middle;">
                            <a href="<?=NEXT_PAGE?>?ref=<?=f_encode($nSubGroup->navSubGroupID)?>" class="btn btn-success" style="width:100px;">Editar</a>
                        </td>
                      </tr>
