...
@define('PAGE_NAME', 'FAST INFOS - QR CODES');
@define('NEXT_PAGE', '_fastInfos.frm');
                  ...
                  <table class="table table-striped" id="datalist">
                      <thead>
                          <tr>
                              ...
                              <th style="text-align:left;width:20%">TITLE</th>
                        ...
                        <?php 
                            ...
                            $fastInfos = (new FastInfos())->find("shipCode=:ship AND deleted_at IS NULL","ship={$sCode}")->fetch(true);
                            if($fastInfos){
                        foreach($fastInfos as $fastInfo){
                    ?>
                    <tr class="odd gradeX">
                        <td style="text-align:center;vertical-align: middle;"><?=$fastInfo->fastInfoID?></td>
                        <!-- 
                        <td style="text-align:center;vertical-align: middle;">
                          <a href="<?=NEXT_PAGE?>?ref=<?=f_encode($fastInfo->fastInfoID)?>" ><?=$fastInfo->fastInfoUUID?></a>
                        </td>
                        -->
                        <td style="text-align:left;vertical-align: middle;font-weight:bold"><?=$fastInfo->fastInfoTitle?></td>
                        <td style="text-align:left;vertical-align: middle;font-weight:bold"><?=$fastInfo->fastInfoFileOriginal?></td>
                        <td style="text-align:center;vertical-align: middle;">
                          <span style="padding:10px 30px 10px 30px;" class="label <?=$aFastInfoStatusLabel[$fastInfo->fastInfoStatus]?>"><?=$aFastInfoStatus[$fastInfo->fastInfoStatus]?></span>
                        </td>
                        <td class="center" style="text-align:center;vertical-align: middle;">
                            <a href="<?=NEXT_PAGE?>?ref=<?=f_encode($fastInfo->fastInfoID)?>" class="btn btn-success" style="width:100px;">Change</a>
                        </td>
                      </tr>
