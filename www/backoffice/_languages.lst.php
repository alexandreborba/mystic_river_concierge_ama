...
@define('NEXT_PAGE', '_languages.frm');
                  ...
                  <table class="table table-striped" id="datalist">
                      <thead>
                          <tr>
                              ...
                              <th style="text-align:center;width:10%"><?=$dict->translate('Is Visible',$langCode);?></th>
                              <th style="text-align:center;width:7%"><?=$dict->translate('Code',$langCode);?></th>
                              <th style="text-align:left;width:auto"><?=$dict->translate('Name',$langCode);?></th>
                              <!-- <th style="text-align:left;width:auto">TOKEN</th> -->
                        ...
                        <?php 
                            ...
                            $langs = (new SysLanguages())->find("deleted_at IS NULL")->fetch(true);
                            if($langs){
                                foreach($langs as $lang){
                                ?>
                                    <tr class="odd gradeX">
                                        <td style="text-align:center;vertical-align: middle;font-weight:normal;"><?=$lang->langID?></td>
                                        <!-- 
                                        <td style="text-align:center;vertical-align: middle;font-weight:normal;">
                                        <a href="<?=NEXT_PAGE?>?ref=<?=f_encode($lang->langID)?>" ><?=$lang->langUUID?></a>
                                        </td>
                                      -->
                                      <td style="text-align:center;vertical-align: middle;font-weight:normal"><?=$aNY[$lang->langIsVisible]?></td>
                                        <td style="text-align:center;vertical-align: middle;font-weight:normal"><?=$lang->langCode?></td>
                                        <td style="text-align:left;vertical-align: middle;font-weight:bold"><?=$lang->langName?></td>
                                        
                                        <td style="text-align:center;vertical-align: middle;font-weight:normal;">
                                        <span style="padding:10px 30px 10px 30px;" class="label <?=$aLanguagesStatusLabel[$lang->langStatus]?>"><?=$aLanguagesStatus[$lang->langStatus]?></span>
                                        </td>
                                        <td class="center" style="text-align:center;vertical-align: middle;">
                                            <a href="<?=NEXT_PAGE?>?ref=<?=f_encode($lang->langID)?>" class="btn btn-success" style="width:100px;">Alterar</a>
                                        </td>
                                    </tr>
