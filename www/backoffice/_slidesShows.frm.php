...
@define('NEXT_PAGE', '_slidesShows.sbm');
@define('PREVIUS_PAGE', '_slidesShows.lst');
...
if ($id) {
    $action = 'upd';
    $slide = (new SlidesShows())->findById($id);
    foreach ($slide->Data() as $field => $value) {
        ${$field} = ($field !== '') ? trim($value) : null;
    }
    $slideUUID = (empty($slideUUID)) ? $newUUID : $slideUUID;
}
            ...
            <div class="col-md-12">
              <div class="grid simple">
                ...
                <form name="form" action="<?php echo NEXT_PAGE; ?>" method="post" enctype="multipart/form-data">
                  ...
                  <input type="hidden" id="slideUUID" name="slideUUID" value="<?=$slideUUID; ?>">
                  <?php
                  if ($action = 'upd') {
                      echo ($slideID) ? chr(10).chr(9).chr(9).chr(9).chr(9)."<input type='hidden' id='slideID' name='slideID' value='{$slideID}'>".chr(10) : null;
                      echo "<input type='hidden' id='slideFile' name='slideFile' value='{$slideFile}'>".chr(10);
                      echo ($slideFileOriginal) ? chr(9).chr(9).chr(9).chr(9)."<input type='hidden' id='slideFileOriginal' name='slideFileOriginal' value='{$slideFileOriginal}'>".chr(10) : null;
                  }// end if
                  ?>
                  <!-- row -->  
                  <div class="row">
                    ...
                    <div class="col-md-4 col-sm-4 col-xs-4">
                      <div class="form-group">                        
                        ...
                        <div class="controls">
                        <p style='font-family:roboto;color:#dadada;font-weight:bold'><?=$slideUUID; ?></p>
                        </div>
                      </div>
                    </div>
                  ...
                  <div class="row" style="margin-top:1%">
                    ...
                    <?php 
                      ...
                      if($slideFile && file_exists('../'.CONCIERGE_SSHOW_IMAGE_FOLDER.$slideFile)){
                        
                        echo    '<div class="col-md-11 col-sm-11 col-xs-11">';
                        echo      '<label class="form-label">File</label>';
                        echo      '<div class="controls">';
                        echo        '<img src="../'.CONCIERGE_SSHOW_IMAGE_FOLDER.$slideFile.'" style="width:90%; border:1px dotted #ccc; padding:5px; margin:5px;">';
                        echo      '</div>';
                        echo    '</div>';
                  ...
                  <!-- row -->  
                    ...
                    <div class="col-md-8 col-sm-8 col-xs-8">
                      <div class="form-group">
                        <label class="form-label">New Image File [ 4K 2160p 3840 x 2160px is the recommended size ]</label><br>
                        <span class="help">(png, jpg, jpeg and webp)</span>
                        <div class="controls">
                          <input type="file" id="slideFileNew" name="slideFileNew"  class="form-control" accept="image/png,image/jpg,image/jpeg,image/webp" >
                          <label id="slideFileNew" style="padding-left:5px;font-size:12px" class="form-label error"></label>
                        </div>
                      </div>
                    </div>
                  </div>
                  ...
                  <?php     
                      if($slideFile && file_exists('../'.CONCIERGE_SSHOW_IMAGE_FOLDER.$dmFile)){
                  ?>
                  <!-- row -->  
                  ...
                  <div class="col-md-3 col-sm-3 col-xs-3">
                    <div class="form-group">
                      ...
                      <div class="controls">
                        <p style='color:#0969da'><?=($slideFileSize) ? f_filesSizeFormatShort($slideFileSize) : null ; ?></p>
                      </div>
                    </div>
                  </div>
                  ...
                  <div class="col-md-3 col-sm-3 col-xs-3">
                    <div class="form-group">
                      ...
                      <div class="controls">
                        <p style='color:#0969da'><?=$slideFileDimensions.' px'; ?></p>
                      </div>
                    </div>
                  </div>
                  ...
                  <div class="row" style="margin-top:2%">
                    <div class="col-md-6 col-sm-6 col-xs-6">
                      <div class="form-group">
                        ...
                        <div class="controls">
                          <input type="text" id="slideCaption" name="slideCaption"  class="form-control" style="font-weight:bold"  value="<?=$slideCaption;?>">
                          <label id="slideCaption" style="padding-left:5px;font-size:12px" class="form-label error"></label>
                        </div>
                      </div>
                    </div>
                    ...
                    <div class="col-md-2 col-sm-2 col-xs-2">
                      <div class="form-group">
                        ...
                        <span class="help"></span>
                        <div class="controls">
                          <input type="number" id="slideOrder" name="slideOrder"  class="form-control" style="font-weight:bold;text-align:right;"  value="<?=$slideOrder;?>">
                          <label id="slideOrder" style="padding-left:5px;font-size:12px" class="form-label error"></label>
                        </div>
                      </div>
                    </div>
                  ...
                  <div class="row" style="margin-top:1%">
                    ...
                    <div class="col-md-2 col-sm-2 col-xs-2">
                      <div class="form-group">
                        ...
                        <span class="help"></span>
                        <div class="controls">
                          <select class="form-control" name="slideStatus" id="slideStatus">
                          <?php
                          if ($aDpStatus) {
                            foreach ($aDpStatus as $key => $value) {
                              $selected = ($key == $slideStatus) ? 'selected' : '';
                    ...
                    <div class="col-md-8 col-sm-8 col-xs-8">
                      <div class="form-group">
                        <div class="controls">
                          ...
                          <?php echo (isset($slideID)) ? "<button class='btn btn-danger' name='btnDelete' style='width:100px;margin-right:20px'>Delete</button>" : null; ?>
    ...
    <script>
      $(document).ready(function() {
        ...
        function formValidate(){
          ...
          if($("input[name=action]").val() == "ins" && $("input[name=slideFile]").val() == ""){
            if ($("input[name=slideFileNew]").val() == "")  {
              err.push(['slideFileNew', 'Select the file']);
            }
          }
