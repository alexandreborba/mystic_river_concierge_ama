...
--
-- Host: mysql01L:3306
-- Tempo de geração: 19/09/2025 às 08:53
...
--
ALTER TABLE `conciergeDailyMenusTypes`
  MODIFY `dmTypeID` int NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=2;
...
--
ALTER TABLE `conciergeShips`
  MODIFY `shipID` int NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=2;
